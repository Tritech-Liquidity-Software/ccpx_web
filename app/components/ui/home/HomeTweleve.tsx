        ...
        <>
            ...
            {showModal && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="sec-eleven-card-one p-6 rounded-lg shadow-lg text-center">
                        ...
                        <button onClick={handleCloseModal} className="mt-4  px-4 py-2 text-white bg-gradient-to-r from-[#00baa9] to-black rounded-lg border-[.8px] border-[rgba(153,153,153,0.5)] backdrop-blur-2xl transition-all ease-in-out duration-300">Close</button>
                    </div>
                </div>)
            }
        </>
