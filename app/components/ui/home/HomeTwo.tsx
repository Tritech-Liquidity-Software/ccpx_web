...
const HomeTwo = () => {
    return (
        <div className="pt-16 pb-32 max-sm:pb-12 max-sm:pt-6" id="features">
            <h2 className="text-3xl font-semibold text-[#00BAA9] text-center pb-28 max-sm:pb-12 max-sm:text-2xl">Features of CCPEX</h2>
            <Container>
                <div className="grid grid-cols-3 max-sm:grid-cols-1 gap-x-6 gap-y-6 px-12 max-sm:px-4 h-full">
                    <div className="w-full flex flex-col items-center h-full">
                        ...
                        <div className="sec-two-card1 w-full rounded-2xl flex flex-col items-center h-full pb-8">
                            ...
                            <h3 className="text-xl font-medium text-white text-center max-sm:text-sm">Decentralized and secure <br className="max-sm:hidden" /> trading.</h3>
                        </div>
                    </div>
                    <div className="w-full flex flex-col items-center h-full">
                        ...
                        <div className="sec-two-card2 w-full rounded-2xl flex flex-col items-center h-full pb-8">
                            ...
                            <h3 className="text-xl font-medium text-white text-center max-sm:text-sm">Powered by Organized <br className="max-sm:hidden" /> Intelligence.</h3>
                        </div>
                    </div>
                    <div className="w-full flex flex-col items-center h-full">
                        ...
                        <div className="sec-two-card3 w-full rounded-2xl flex flex-col items-center h-full pb-8">
                            ...
                            <h3 className="text-xl font-medium text-white text-center max-sm:text-sm">Potential for up to 2% daily <br className="max-sm:hidden" /> profits.</h3>
                        </div>
                    </div>
                </div>
            </Container>
