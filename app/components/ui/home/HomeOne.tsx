            ...
            <Container>
                <div className="grid grid-cols-2 max-sm:grid-cols-1 gap-x-6 items-center px-10 max-sm:px-6">
                    <div>
                        ...
                        <p className="text-lg font-normal text-white py-3">Generate up to 2% daily profits with advanced Organized Intelligence built on Dr. Ernest Chans principles.</p>
