...
const HomeSeven = () => {
    return (
        <div className="pt-36 max-sm:pt-6">
            <Container>
                <div>
                    <h4 className="text-3xl font-semibold text-[#00BAA9] text-center pb-10 max-sm:pb-6">OI Bots - AI Trading Powered by Dr. Ernest Chan's Strategy</h4>
                    <p className="text-xl font-normal text-white text-center py-2">CCPX offers three specialized OI Bots trained on Dr. Ernest Chan's strategy to maximize <br className="max-sm:hidden" /> trading efficiency and profit potential.</p>
                    <div className="grid grid-cols-3 max-sm:grid-cols-1 px-12 max-sm:px-2">
                        ...
                        <div className="col-span-1 h-full">
                            <h5 className="text-xl font-normal text-[#00BAA9] relative right-20 top-20 mt-5 max-sm:static max-sm:text-center">Dr. Chan's Trading Strategy :</h5>
